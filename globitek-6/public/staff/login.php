...
if(is_post_request() && request_is_same_domain()) {
  ...
  if (empty($errors)) 
  {
    if(($throttle = throttle_time($username)) === 0) 
    {
      ...
      {
        // No username found
        password_verify($password, $password); // just to deceive attackers;
    ...
    {
      echo "Too many failed logins for this username. 
            You will need to wait " . ceil($throttle) . " minutes before 
