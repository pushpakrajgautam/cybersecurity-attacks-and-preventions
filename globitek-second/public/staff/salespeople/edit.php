...
?>
<?php $page_title = 'Staff: Edit Salesperson ' . htmlspecialchars($salesperson['first_name'] . " " . $salesperson['last_name']); ?>
<?php include(SHARED_PATH . '/header.php'); ?>

<div id="main-content">
  <a href="index.php">Back to Salespeople List</a><br />

  <h1>Edit Salesperson: <?php echo htmlspecialchars($salesperson['first_name'] . " " . $salesperson['last_name']); ?></h1>
